...
class Sewa extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['id_penyewa'], 'exist', 'skipOnError' => true, 'targetClass' => Penyewa::class, 'targetAttribute' => ['id_penyewa' => 'id_penyewa']],
        ];
    }
    ...
    {
        return $this->hasOne(DetailSewa::class, ['no_nota' => 'no_nota']);
    }
    ...
    {
        return $this->hasOne(Penyewa::class, ['id_penyewa' => 'id_penyewa']);
    }
}
