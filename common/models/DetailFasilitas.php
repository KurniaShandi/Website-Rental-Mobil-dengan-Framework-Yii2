...
class DetailFasilitas extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['kode_fasilitas'], 'exist', 'skipOnError' => true, 'targetClass' => Fasilitas::class, 'targetAttribute' => ['kode_fasilitas' => 'kode_fasilitas']],
        ];
    }
    ...
    {
        return $this->hasOne(Fasilitas::class, ['kode_fasilitas' => 'kode_fasilitas']);
    }
