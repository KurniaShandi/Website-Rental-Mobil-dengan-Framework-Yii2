...
/** @var common\models\SewaSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Data Sewa';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="sewa-index content">
    <div class="row">
        <div class="col-12">
            <div class="card">
